            ...
            <form name="frm1" method="post" action="qna_edit_ok.php">
                <table class="board_write_table">
                    ...
                    <tr>
                        <td>내용</td>
                        <td>
                            <textarea name="content" cols="100" rows="10"  class="board_write_textarea" >
                    ...
                    <tr>
                        <td colspan="2" style="background-color:white" align="center">
                            ...
                            <input type="button" value="뒤로가기" onclick="location.href='qna_content.php?no=<?php echo $no?>'" class="board_write_bt" style="background-color:#333">
                        </td>
                    </tr>
                    <?php }?>
                        <!-- send 스크립트 -->
