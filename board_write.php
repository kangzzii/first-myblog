...
<body>
    ...
    <div id="notice">
        <form name="frm1" method="post" action="board_write_ok.php">
        <table class="board_write_table">
            ...
            <tr>
                <td>내용</td>
                <td>
                    <textarea name="content" cols="1000" rows="10" placeholder="내용을 입력하세요" class="board_write_textarea" ></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="background-color:white" align="center">
                    ...
                    <input type="button" value="뒤로가기" onclick="location.href='board.php'" class="board_write_bt" style="background-color:#333">
                </td>
            </tr>
            <script>
                function send(){
