...
<body>
    ...
    <div id="notice">
        <table class="i3">
            ...
            <tr>
                <td colspan="3">
                    <input type="button" value="자료실 추가" onclick="location.href='inc_write.php'">
                </td>
            </tr>
            <?php }?>
           </table>
           ...
           <div class="i6">
                <p>
                    ...
                    for($i=$startpage;$i<=$endpage;$i++){
                        ...
                        if($i == $page){
                            echo  "<a href='inc.php?page=$i'><font color='red'><&ensp; $i &ensp;></font></a>";
                        }else{
                    ?>
                    < &ensp; <a href="inc.php?page=<?php echo $i?>"><?php echo $i?></a> &ensp; >
                    <?php } }
                    if($group<$groupcount){
                        $nextpage=$group*5+1;
