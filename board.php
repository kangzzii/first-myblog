...
<body>
    ...
    <div id="notice">
        <table class="i3">
            ...
            <tr>
                <td colspan="3">
                    <input type="button" value="게시판 추가" onclick="location.href='board_write.php'">
                </td>
            </tr>
            <?php }?>
           </table>
           ...
           <div class="i6">
                <p>
                    ...
                    if($group>1){
                        ...
                        echo "<a href='board.php?page=$prevpage'>PREV</a>&nbsp;";
                    }
                    for($i=$startpage;$i<=$endpage;$i++){
                        if($i>$pagecount){break;}
                        if($i == $page){
                            echo  "<a href='board.php?page=$i'><font color='red'><&ensp; $i &ensp;></font></a>";
                        }else{
                    ?>
                    < &ensp; <a href="board.php?page=<?php echo $i?>"><?php echo $i?></a> &ensp; >
                    <?php } }
                    if($group<$groupcount){
                        $nextpage=$group*5+1;
                        echo "<a href='board.php?page=$nextpage'>NEXT</a>";
                    }
                    ?>
