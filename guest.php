...
<body>
    ...
    <div id="notice">
        <form name="frm1" method="post">
            ...
            <!-- 원글에 대한 댓글 끝 -->
                <?php if(isset($_SESSION["id"])){ ?>
                <a href="#" onclick="send('re_data<?php echo $i ?>',<?php echo $row["no"]?>,<?php echo $page?>)"><font color="orange">답글 작성</font></a>
                <?php } ?>
            ...
            <script>
                function send(p,p_no,page){
                    ...
                    document.getElementById(p).innerHTML="<input type='text' name='re' size='70'> <input type='hidden' name='p_no' value='"+p_no+"'><input type='hidden' name='page' value='"+page+"'><a href='#' onclick='resend()'>답글</a> <a href='#' onclick='reclose()'>close</a>";
                }
                function reclose(){
                    if(document.getElementById("re_data1")){
                        document.getElementById("re_data1").innerHTML="";
         ...
         <!-- 페이지 -->
            <br><br>
            <div id="page" style="width:600px;text-align:center;padding:5px">
                <?php
